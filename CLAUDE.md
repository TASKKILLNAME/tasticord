...
Required: `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY`, `SPOTIFY_CLIENT_ID`, `SPOTIFY_CLIENT_SECRET`, `YOUTUBE_CLIENT_ID`, `YOUTUBE_CLIENT_SECRET`, `STEAM_API_KEY`, `ANTHROPIC_API_KEY`, `LASTFM_API_KEY` (Wrapped 카드 3번의 Top Genres 집계용 — Spotify 장르 deprecated 대체). Optional: `TMDB_API_KEY`.
